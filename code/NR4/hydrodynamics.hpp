...
struct hydrodynamic_utility_buffers : buffer_provider
{
    ...
    hydrodynamic_utility_buffers(cl::context ctx) : w(ctx), P(ctx), intermediate(ctx){}
...
struct hydrodynamic_plugin : plugin
{
    ...
    virtual void finalise(cl::context ctx, cl::command_queue cqueue, buffer_provider* out, t3i dim, cl::buffer evolve_points, cl_int evolve_length) override;
