...
Conformal variables in general have a tilde over them, and have their indices are raised and lowered with the conformal metric tensor. In this definition, the trace of the conformal metric is $1$, and $\tilde{A}_{ij}$ is trace-free. $K$ is the trace of $K_{ij}$
