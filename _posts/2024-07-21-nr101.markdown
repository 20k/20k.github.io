...
We now have all of the theory out of the way, phew. Its time to get into the code. I'm going to try and limit the discussion here to anything which isn't just 1:1 translating equations into code, because there are some subtleties
