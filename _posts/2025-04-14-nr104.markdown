...
If you remember from our black hole initial conditions paper, the basic idea for many kinds of initial conditions is based on the principle of a conformal transform, where your variables are multiplied by a conformal factor: $\Phi$
...
Where $R$ is the radius of the star in schwarzschild coordinates, and $M$ is the total ADM mass (ie the integral of $m(r)$). Technical details of how this works is available on the linked page
...
Todo: List the explicit test case
...
I'm going to leave this topic alone now
