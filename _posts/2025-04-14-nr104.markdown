...
4. After all of this, we then to construct our final hydrodynamic variables - like velocity, density, and energy density. Along the way, we'll be constructing our ADM variables as well, though this is much simpler
...
$W$ is a lorentz factor ($=-n_\mu u^\mu$), and $u^i$ is the spatial components of a fluid 4-velocity. These two variables fully encompass our fluid's state here, and *also* fully determine the structure of our spacetime. Calculating these is a major goal here
