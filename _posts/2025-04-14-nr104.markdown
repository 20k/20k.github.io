...
If you’re looking for someone with a lot of enthusiasm for GPU programming, and who’d rather love to do a PhD in numerical relativity - please give me a shout![^contact]
...
In general, you'll need to numerically invert the equation of state for some arbitrary equation. So, what's the deal with the equation of state?
...
Where $W$ is a lorentz factor, and $u^i$ is the spatial components of a fluid 4-velocity. These two variables fully encompass our fluid's state here, and *also* fully determine the structure of our spacetime. Calculating these is a major goal here
