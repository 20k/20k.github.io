...
You should know before we get into this, that it is going to be a *huge* pain, so saddle up. The code for the first half of this article is available as a standalone library [here](https://github.com/20k/libtov), and the second half of this article is available over [here](https://github.com/20k/20k.github.io/blob/master/code/NR4)
