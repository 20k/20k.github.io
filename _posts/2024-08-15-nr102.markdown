...
valuef diff1_boundary(single_source::buffer<valuef> in, int direction, const valuef& scale, v3i pos, v3i dim)
{
    ...
    //not strictly necessary for boundary derivatives
...
Other boundary conditions are discussed at the end of this article
...
Reducing derivative order near the singularity: This appears to better preserve energy at low resolutions
