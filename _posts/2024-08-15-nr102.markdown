...
Simply apply this repeatedly to a grid, and you've solved your laplacian. For us, $F(u) = -\frac{1}{8} (\frac{1}{\alpha} + u + 1)^{-7} \bar{A}_{ij} \bar{A}^{ij}$
                        ...
                        buffer_mut<valuei> still_going, literal<valuef> relax)
{
    ...
    //cfl is 1 + 1/alpha, in[lid] is our guess for u
