...
This equation can be used to solve for a specific ADM mass by binary searching. There is no way a priori to get a specific ADM mas, so this is the only way to do it
