...
We're primarily going to be relying on the second technique in this article
...
The next technique we're going to use is actually a new one for me, and is called slow start lapse
