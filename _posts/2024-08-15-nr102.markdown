...
There are a variety of schemes available for improving the christoffel symbols
...
The analytic value is standard to calculate as well:
...
All in all: Not great, not terrible. We won't be using this modification on a permanent basis
...
In general, my experience of this is that its one we can simply discard
