...
(Please note that the side view suffers from inaccuracy, and shouldn't cut off with such a hard boudary - we'll fix this next time. The tetrads become fairly degenerate near the singularity, at r=0.1)
