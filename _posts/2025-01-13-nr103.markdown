...
Converting the ADM variables from the BSSN variables works as follows:
...
With the 4-metric being constructed as such:
...
The ADM variables are constructed via a trilinear interpolation, which is terribly unexciting:
...
The basic form of any raytracing scheme is as follows:

Todo: Initialisation, raytracing, rasterisation
