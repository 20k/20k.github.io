...
Note that `no_opt` in the scheme I'm using forces a variable declaration, to disable fp contraction. This `lmix` guarantees the property:

$$\mathrm{lmix}(a, b, t) == \mathrm{lmix}(b, a, 1-t)$$

## Trilinear Interpolation isn't that great
