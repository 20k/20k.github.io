...
This implementation was severely complicated by bugs in AMD's GPU compiler, which is why these memory accesses are not just standard loops, and I have to emit GPU loops over constants
