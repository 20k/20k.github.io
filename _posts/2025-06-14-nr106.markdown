...
At the end of this topic, we'll have about 10 million particles up and running at a decent speed, and you'll have also received an accidental crash course on the problems a spec defect in C++ can cause
...
If you try and implement this with a simple test case (two particles orbiting each other), you'll quickly run into a rather odd issue:

Todo: Video

You're now going to learn more about C++, IEEE floats, and cryptic problems in the literature than you signed up for when you clicked on this article
