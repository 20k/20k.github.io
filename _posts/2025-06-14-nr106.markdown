...
2. The 4-momentum is a poor choice of evolution variable. We'll be dealing with particles with *very* tiny masses, so with an extremely small 4-momentum, the velocity will be very inaccurate
