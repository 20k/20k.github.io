...
I haven't found this modification to be at all important in practice, so its disabled by default. There's a little more detail about this issue when we discuss the vacuum boundary conditions for $v^i$
...
Before we get to the results, and overall discussion, its worth talking about this hydro formalism a bit more generally. Digging into a past project again equipped with much more knowledge and a critical eye was absolutely fascinating, and I learnt a lot about hydrodynamics along the way
...
This - in theory - would all be solved by a newer formalism. This formalism isn't 'bad', and its an extremely interesting test-case on modern hardware compared to what they could get away with in 2002
