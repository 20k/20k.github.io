...
Where $\chi = 0.9$, $k_{\gamma} = -0.18$, and $C = 0.15$
...
I did some fairly extensive testing of various operator splitting methods vs treating these as regular evolution equations for this article, and was not able to find any stability difference at all. Operator splitting requires a few extra buffers of storage for intermediate variables, so in this case it was strictly worse
...
You'll also have to work out the quantity $u_0$ if you're deriving this by hand. Todo: Do this
