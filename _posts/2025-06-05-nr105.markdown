...
In general, these options seem to be fairly identical, so you may as well use the first. I've been using the second purely for commonality with the referenced implementation
