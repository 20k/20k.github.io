...
This is actually a catastrophic amount of implementation work, and I spent way too long on it for no reason. Here's what it looks like:
...
Or, if you're willing to put in a truly ludicrous amount of effort, you can even use a texture:
