...
(If the symbols aren't rendering, try a force refresh). These are the evolution variables. I've translated the paper's old-style conformal factor $\phi$, into the newer conformal factor $W$ - and a table of conversions is provided at the end of this article
