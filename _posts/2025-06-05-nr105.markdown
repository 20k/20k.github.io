...
In general, this is one of the reasons why this formalism was ditched - more modern formalisms are expressed purely in terms of conserved quantities, which makes their hydro treatment more rigorous at the expense of complexity
...
I've listed a derivation in the appendix
...
The singular part is the divisor of $D$, and to fix it you can simply clamp the bottom to a small constant. This division is simply clamped - and there's a detailed explanation in the appendix (as this is a systematic approach)
...
In general, its a good idea to avoid calculating $\rho_0$ if possible, as calculating $\rho_*^2$ is numerically suspect. Some usefully optimised quantities are:
...
(\rho_0 \epsilon)^{-1 + \frac{1}{\Gamma}} &= \frac{I}{I^\Gamma}
\end{align}$$

The odd fraction at the end is for floating point reasons[^herbie]

[^herbie]: Specifically, because herbie says its better [link](https://herbie.uwplse.org/demo/52581ebe88144c24f862a2121f196a594ce8656d.1a83c9f5186db102b678a2d5f869f99992469071/graph.html)
...
The actual viscosity calculation itself:
...
I've already shown off the advection equation portion, so this is just the RHS's now:
