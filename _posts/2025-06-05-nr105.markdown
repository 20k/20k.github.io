...
$\phi$ is a *flux* limiter. There's nothing different here to the slope limiting equations, its just a different way of limiting stuff. We'll be using the superbee limiter: todo
