...
$F$ is our flux, and $i$ is the grid cell. Here, $F_i = v_i q_i$. The half fluxes $F_{i - 1/2}$ and $F_{i + 1/2}$ are the complexity of hydrodynamics. $u^*$ is actually a function
