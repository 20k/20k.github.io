...
Todo: Define $E^z$
Todo: I definitely need to harmonise notation. $E^z -> \epsilon$
...
1. $M(0) = \frac{4}{3} \pi r_{min}^3 \mu_0$,
2. $P(0) = K \rho_{c}^\Gamma$, where $\rho_{c}$ is the central rest mass density

$\mu_0$ is the energy density at the centre of the star, calculated from the rest central density
