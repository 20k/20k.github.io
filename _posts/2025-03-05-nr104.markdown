...
One known consequence of the atmosphere-free formulation is that a thin shell of material drifts away from the star, and remains suspended around it. This isn't ideal. This thin shell can end up superheating, causing unfun code times. This is a similar problem to fluid accelerating massively
