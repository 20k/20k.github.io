...
Ie, we assume a constant $\epsilon$ through the star, then calculate this as a density. This is at least in the ballpark. From there, its a secant search. Lets go!
